...
highed.installLanguage({
  ...
  entries: {
    ...
    'option.subcat.subtitle': 'Subtitle',
    ...
    'option.text.caption.text': 'Caption text',
    'option.tooltip.caption.text':
      'The text you want to display as the caption.',
    'option.text.caption.useHTML': 'Use HTML',
    'option.tooltip.caption.useHTML':
      'Whether to use limited HTML to render the text.',
    'option.text.caption.style': 'Font',
    'option.tooltip.caption.style': 'Font styles for the caption',
    'option.text.caption.margin': 'Margin',
    'option.tooltip.caption.margin':
